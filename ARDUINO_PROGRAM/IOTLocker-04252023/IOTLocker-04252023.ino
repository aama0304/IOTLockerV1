...
LiquidCrystal_I2C  lcd2(0x25, 2, 1, 0, 4, 5, 6, 7, 3, POSITIVE); //LCD Module for Locker 2 [CHANGE I2C ADDRESS]
LiquidCrystal_I2C  lcd3(0x26, 2, 1, 0, 4, 5, 6, 7, 3, POSITIVE); //LCD Module for Locker 3 [CHANGE I2C ADDRESS]
LiquidCrystal_I2C  lcd4(0x23, 2, 1, 0, 4, 5, 6, 7, 3, POSITIVE); //LCD Module for Locker 4 [CHANGE I2C ADDRESS]

// RFID VARIABLES

String RFID1 = " E0 72 F4 19"; // set the RFID contents here
String RFID2 = " 11 A0 11 26";
String RFID3 = " 80 EC 4B 25";
String RFID4 = " D3 40 09 BA";
...
void initSerialCommands()
{
  ...
  sCmd.addCommand("Di1LockerDone", DisinfectLocker1Done);
  sCmd.addCommand("Di2LockerDone", DisinfectLocker2Done);
  sCmd.addCommand("Di3LockerDone", DisinfectLocker3Done);
  sCmd.addCommand("Di4LockerDone", DisinfectLocker4Done);
}
///////////// DATA FUNCTIONS /////////////
...
void ReadRFID1()
{
  ...
  Serial.println(IDcontent1);
  if (IDcontent1 == RFID1) // Make sure you change this with your own UID number
  {
    if (DisinfectLock1 == false)
    {
  ...
  else if (IDcontent1 == RFID2) // Make sure you change this with your own UID number
  {
    if (DisinfectLock2 == false)
    {
  ...
  else if (IDcontent1 == RFID3) // Make sure you change this with your own UID number
  {
    if (DisinfectLock3 == false)
    {
  ...
  else if (IDcontent1 == RFID4) // Make sure you change this with your own UID number
  {
    if (DisinfectLock4 == false)
    {
